...
const data = {
  ...
  rows: [
      ...
      },
      {
        ...
        content:
        <p>
          If you have an Android, you can download the free Chess Academy app&nbsp;
          <a target="_blank" href="https://play.google.com/store/apps/details?id=com.camerachess.www.twa" rel="noreferrer">here</a>.
          If you have an IPhone, you can add Chess Academy to your home screen from the browser.
